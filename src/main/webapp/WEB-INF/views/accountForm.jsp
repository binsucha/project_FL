...
<jsp:include page="mypage/accountForm.jsp"></jsp:include><br>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: center;">
        <span id="modalMesg"></span><br>
        <br>
        <input type="text" id="modalText"></input>
        <button type="button" class="btn btn-outline-primary btn-sm" id="check">중복 확인</button>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="okay">사용</button>
...
<button type="button" id="checkModalBtn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#checkModal" style="display: none;">modal</button>
<!-- end modal -->
<!-- modal -->
<div class="modal" id="deleteModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: center;">
        <span id="deleteMesg"></span><br>
        <br>
        <input type="password" id="textArea"></input>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="okayDelete">탈퇴</button>
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">닫기</button>
      </div>
    </div>
  </div>
